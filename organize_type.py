...
def main(mapping_file, name_field, main_field, source_directory, file_extension):
    '''
    ...
    with open(source_directory + mapping_file, 'r') as mapping:
        ...
        for row in reader: 
            ...
            print(source_directory + row[name_index] + file_extension)
            if os.path.isfile(source_directory + row[name_index] + file_extension):
    ...
    print("There are now " + str(file_count) + " total files in " + str(folder_count) + " main folders and " )
...
if __name__ == "__main__":
    ...
    main(args.mapping_file, args.name_field, args.main_field, args.source_directory, args.file_extension)